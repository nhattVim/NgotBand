...
$sql = "SELECT id_product, name_product, price, img_product, img_product2 FROM catolog WHERE type='digital'";
                        ...
                        <div class="footer-content">
                            <div class="footer-content-left">
                                ...
                                <ul class="footer-social">
                                    ...
                                    <li><a href="https://www.youtube.com/c/Ngọtband"><i class="fa-brands fa-youtube"></i></i></i></a></li>
                                </ul>
                            </div>
