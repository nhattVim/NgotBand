...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['register'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($sql) === TRUE && $conn->query($sql1)) {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'nhattruong13112000@gmail.com';
            $mail->Password = 'civn zagu bchq bawc ';
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;

            $mail->setFrom('nhattruong13112000@gmail.com', 'Ngọt');
            $mail->addAddress($email, $username);

            $mail->isHTML(true);
            $mail->Subject = 'Ngọt - Đăng ký thành công';
            $mail->Body = '<strong> ' . $username . ' đã đăng ký thành công.</strong> <br> <br>
            <strong>Chúc bạn có thời gian trãi nghiệm trang web siêu tuyệt vời này của chúng tôi một cách sảng khoái nhất :D</strong>';
        ...
        <div class="panels-container">
            ...
            <div class="panel right-panel">
                <div class="content">
                    ...
                    <p>Hãy nhấn vào nút đăng nhập, điền tên người dùng và mật khẩu để truy cập vào tài khoản của bạn.
                    </p>
