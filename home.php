...
<body>
    <div id="main">
        ...
        <div id="center">
            <div id="layout">
                <div id="content">
                    ...
                    <div id="banner">
                        <div class="banner-background">
                            <?php
                            $sql = "SELECT id_album, name_album, img_album FROM album WHERE name_album = 'HIT'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo '<a href="music.php?id_album=' . $id_album . '">
                    <img src="./assets/img/music/' . $img_album . '" alt="' . $name_album . '" />
                    <h1>' . $name_album . '</h1>
                  </a>';
                            } else {
                    ...
                    <div id="album">
                        ...
                        <?php
                        $sql = "SELECT id_album, name_album, img_album, author, sl_song, year FROM album where type = 'album' order by year desc";
                        $result = $conn->query($sql);
                ...
                <p class="item-songs">' . $sl_song . ' bài hát</p>
                </a>
            </div>';
                            }
                            echo '</div> </a>';
                    ...
                    <div id="single">
                        <h1 class="section-title">Single</h1>
                        <?php
                        $sql = "SELECT id_album, name_album, img_album, author, sl_song, year FROM album where type = 'single' order by year desc";
                        $result = $conn->query($sql);
                ...
                <p class="item-songs">' . $sl_song . ' bài hát</p>
                    ...
                    <div id="mv">
                        ...
                        <?php
                        $sql_songs = "SELECT id_mv, name_mv, img_mv, file, type FROM mv where type='mv'";
                        ...
                        <div class="pop-mv">
                            <?php foreach ($songs as $song) { ?>
                                <div class="mv-item">
                                    <a href="#" data-video="<?php echo $song['file']; ?>" class="btn-mv">
                ...
                <div class="footer-content">
                    ...
                    <div class="footer-link">
                        <div class="footer-social-list">
                            ...
                            <a href="https://music.apple.com/us/artist/ngß╗ìt/1291453081"><i
                                    class="fa-solid fa-music"></i></a>
                            <a href="https://open.spotify.com/artist/0V2DfUrZvBuUReS1LFo5ZI"><i
    ...
    <script>
        ...
        const music = new Audio("./assets/music/dunglamtraitimanhdau.mp3");
        ...
        Array.from(document.getElementsByClassName("tr")).forEach((element, index) => {
        ...
        let playButtonContainer = document.querySelector(".btn-toggle-play");
    ...
    <div id="videoModal" class="modal">
        <div class="modal-content">
            ...
            <iframe id="modalVideo" width="960" height="540" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
